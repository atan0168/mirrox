...
export default function AnalysisCard({ energyKcal, tags = [], onPressDetails }: Props) {
...
const styles = StyleSheet.create({
  ...
  energyValue: { fontSize: 28, fontWeight: '800', color: '#111827', textAlign: 'center' },
  energyUnit: { marginLeft: 4, fontSize: 14, color: '#6B7280', fontWeight: '600' },
  chipWrap: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', marginTop: 4 },
  chip: {
    paddingHorizontal: 10, paddingVertical: 5, borderRadius: 999,
    backgroundColor: '#F3F4F6', borderWidth: 1, borderColor: '#E5E7EB',
    marginHorizontal: 4, marginVertical: 4,
  },
  chipText: { fontSize: 13, fontWeight: Platform.select({ ios: '600', android: '600' }), color: '#111827' },
  ghostButton: {
    marginTop: 12, paddingVertical: 8, paddingHorizontal: 14, borderRadius: 12,
    borderWidth: 1, borderColor: '#DBEAFE', backgroundColor: '#F8FAFF',
